    ...
    embeds: [
      {
        ...
        description: [
          ...
          `\`${process.env.PREFIX}music\`: Shows you this list of music commands.`,
          ...
          `\`${process.env.PREFIX}stop\`: Disconnect the bot from the voice channel`,
          ...
          `\`${process.env.PREFIX}invite\` : Can Invite me to your Server.`,
        ].join('\n'),
        color: 0x6bbedd,
        footer: {
          text: `This music bot was created with the help from: Light,| DM him if you have questions.`,
        },
      },
    ],
  });
